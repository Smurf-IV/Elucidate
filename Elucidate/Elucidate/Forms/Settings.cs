...
//
//  Copyright (C) 2010-2025 Simon Coghlan (Aka Smurf-IV) & BlueBlock 2018
//
...
public partial class Settings : KryptonForm
{
    ...
    private void PerformSnapShotSourceAddNode(TreeNode selected)
    {
        ...
        if (!Directory.Exists(newPath))
        {
            ...
            KryptonMessageBox.Show(this,
                $"Path does not exist.\nAttempted to add:\n [{newPath}]",
                "Source not added", KryptonMessageBoxButtons.OK, KryptonMessageBoxIcon.Exclamation);
            return;
        }
    ...
    private void editName_Click(object sender, EventArgs e)
    {
        ...
        )
        {
            if (DialogResult.Yes == KryptonMessageBox.Show(this,
                    ...
                    @"Name Change Warning", KryptonMessageBoxButtons.YesNo, KryptonMessageBoxIcon.Question))
            {
    ...
    private void DriveGridOnCellEndEdit(object sender, DataGridViewCellEventArgs e)
    {
        ...
        var coveragePath = selected.Tag as CoveragePath;
